...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.action_img -> {
//                re.insertImage("https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3441287165,971217759&fm=200&gp=0.jpg", "image")
//                re.insertImage("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1537337837013&di=2425ef64d5fa50c214c989cc90caeec5&imgtype=0&src=http%3A%2F%2Fimg12.3lian.com%2Fgaoqing02%2F01%2F58%2F85.jpg", "image")
//                re.insertImage("content://media/external/images/media/55899", "image")
//                re.insertImage("https://xiangxue-topic.oss-cn-hangzhou.aliyuncs.com/3425/1544690581.JPG", "image")


            }// 插入图片
//            R.id.action_img -> re.insertImage("", "image")// 插入图片
