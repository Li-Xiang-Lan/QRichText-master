...
//        val html = intent.getStringExtra("html")
        val html="<p>    <br></p><section class=\"_editor\">    <p>        <br>    </p></section><p>    <img src=\"http://xiangxue-vip.oss-cn-hangzhou.aliyuncs.com/test/cover/1585557540432.png\" title=\"1585557540432.png\" alt=\"直播导图.jpg\"></p>";
        re.html = html
    }
